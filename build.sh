...
axt1800_sdk_get()
{
	...
	echo src-git passwall_packages https://github.com/xiaorouji/openwrt-passwall.git;packages >>${WORKDIR}/openwrt-sdk/feeds.conf.default
	echo src-git passwall_luci https://github.com/xiaorouji/openwrt-passwall.git;luci >>${WORKDIR}/openwrt-sdk/feeds.conf.default
